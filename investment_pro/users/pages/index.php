										...
										<div class="row">
											...
											<div class="col-7 col-stats p-4" >
												<div class="numbers">
													...
													<h4 class="card-title" style="color:#000">$ <?php echo $_SESSION['pprofit'];?> USD</h4>
												</div>
											</div>
										</div>
									</div>
										...
										<div class="row">
											...
											<div class="col-7 col-stats p-4">
												<div class="numbers">
													...
													<h4 class="card-title" style="color:#000">$<?php echo round($_SESSION['walletbalance'],2) + round($_SESSION['pprofit'],2);?> USD</h4>
												</div>
											</div>
										</div>
									</div>
