	...
	<div class="wrapper static-sidebar">
		...
		<div class="main-header">
			...
			<div class="logo-header bg-light" data-background-color="transparent">
				...
				<button class="navbar-toggler sidenav-toggler ml-auto text-dark" type="button" data-toggle="collapse" data-target="collapse" aria-expanded="false" aria-label="Toggle navigation">
					<span class="navbar-toggler-icon text-dark">
						<i class="icon-menu text-dark"></i>
					</span>
				</button>
				<button class="topbar-toggler more bg-dark"><i class="fa fa-cog text-dark"></i></button>
				<div class="nav-toggle pt-3">
            ...
            <nav class="navbar navbar-header navbar-expand-lg bg-light">
...
<script type="text/javascript" src="//translate.google.com/translate_a/element.js?cb=googleTranslateElementInit"></script>
		...
		<div class="classic-grid" >
			<!-- Sidebar -->
			<div class="sidebar sidebar-style-2 bg-transparent" >			
				<div class="sidebar-wrapper bg-transparent scrollbar scrollbar-inner">
					<div class="sidebar-content bg-transparent">
						<div class="user shadow p-3">
							<div class="avatar-sm float-left mr-2 shadow">
						...
						<ul class="nav shadow m-2">
							<li class="nav-item active submenu bg-transparent">
