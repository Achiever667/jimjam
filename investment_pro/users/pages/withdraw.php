...
Copyright ©2019 '.$name.'. </p> <div class="be_logo" style=" width:60px;height:40px;float: right;"> </div> </div> </div> </div></div>';
    ...
    if($mail->send()){
      ...
      $msg= " Your withdraw order of $v  PM has been sent, your transaction ID is $tnx , you  will be credited once your order is confirmed ";
    }
     }
...
<div class="col-md-12 col-sm-12 col-sx-12 mx-auto">
          <div class="box box-default">
            <div class="box-header with-border">

          
        <div class="col-xs-12">
          <div class="box box-default bg-transparent">
            <div class="box-header with-border">
            ...
            <p type="button" class="btn btn-light shadow" style="width:auto; font-size:20px;padding:40px 10px; color: white; " >

                <b> <i class="fas fa-th-list" id="icone"  ></i> Balance: <?php echo round($row['walletbalance'],2);?> USD</b>

              </p>
              </br> </br></br>
              <button style="width:auto" type="button" class="btn btn-light shadow" data-toggle="modal" data-target="#btc">
                Request Bitcoin Withdrawal
              </button>
              </br></br>
              <button style="width:auto" type="button" class="btn btn-light shadow" data-toggle="modal" data-target="#eth">
                Request Ethereum withdrawal
              </button>
              </br></br>
              <button style="width:auto" type="button" class="btn btn-light shadow" data-toggle="modal" data-target="#bnk">
