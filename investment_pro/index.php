...
<html class="no-js" lang="en">
	<head>
		...
		<title>Home | INVpro - Bitcoin & Perfect Money Investment</title>
                    ...
                    <div class="row">
                       <div class="col-md-6 col-sm-6">
                           <div class="topbar-left">
                                <ul>
                                    <li><a href="#"><i class="fa fa-envelope"></i> info@your-domain.com</a></li>
                                    ...
                                    <div class="row">
                                        <div class="col-md-12 col-sm-12 col-xs-12">
                                            ...
                                            <div class="slide-content text-center">
                                                ...
                                                <div class="layer-1-3">
                                                    <a href="users/form/signin.php" class="ready-btn left-btn" >Get started</a>
                                                </div>
                                            </div>
                                            <!-- End Slider content -->
                                        </div>
                    ...
                    <div class="fun-content">
                        <div class="col-md-3 col-sm-6 col-xs-12">
                            ...
                            <div class="fun_text">
                                ...
                                <span class="counter">$2,974,504</span>
                        ...
                        <div class="col-md-3 col-sm-6 col-xs-12">
                            ...
                            <div class="fun_text">
                               <span class="counter-icon"><i class="flaticon-016-graph"></i></span>
                                <span class="counter">$3,174,584</span>
                ...
                <div class="row">
					<div class="col-md-12 col-sm-12 col-xs-12">
						<div class="section-headline text-center">
                            <h3>The Next-Generation Digital Investment</h3>
                            <p>We are an expirienced investment company that offers diverse business options to customers. We trade in monetary, financial and crypto currency in large scale market..</p>
						</div>
					</div>
				</div>
                <div class="row">
                    <div class="pricing-content">
                        <div class="col-md-3 col-sm-6 col-xs-12">
                            <div class="pri_table_list">
                                <div class="top-price-inner">
																	<span class="base">MINI PLAN</span>
                                   <div class="rates">
                                        <span class="prices">1%</span><span class="users">Daily</span>
                                    </div>
                                    <span class="per-day">10 days</span>
                                </div>
                                <ol class="pricing-text">
                                    <li class="check">Minimum Invest : $100</li>
                                    <li class="check">Maximum Invest : $999</li>
                                    <li class="check">Avarage Monthly : 30% </li>
                                </ol>
                                <div class="price-btn blue">
                                    <a class="blue" href="#">Deposit</a>
                                </div>
                            </div>
                        </div>
                        <div class="col-md-3 col-sm-6 col-xs-12">
                            <div class="pri_table_list">
                                <div class="top-price-inner">
																	<span class="base">MAXI PLAN</span>
                                   <div class="rates">
                                        <span class="prices">1.5%</span><span class="users">Daily</span>
                                    </div>
                                    <span class="per-day">10 days</span>
                                </div>
                                <ol class="pricing-text">
                                    <li class="check">Minimum Invest : $1,000</li>
                                    <li class="check">Maximum Invest : $9,999</li>
                                    <li class="check">Avarage Monthly : 45% </li>
                                </ol>
                                <div class="price-btn blue">
                                    <a class="blue" href="#">Deposit</a>
                                </div>
                        ...
                        <div class="col-md-3 col-sm-6 col-xs-12">
                            <div class="pri_table_list">
                                <div class="top-price-inner">
                                   <span class="base">MEGA PLAN</span>
                                   <div class="rates">
                                        <span class="prices">2%</span><span class="users">Daily</span>
                                    </div>
                                    <span class="per-day">10 days</span>
                                </div>
                                <ol class="pricing-text">
                                    <li class="check">Minimum Invest : $10,000</li>
                                    <li class="check">Maximum Invest : $99,999</li>
                                    <li class="check">Avarage Monthly : 60% </li>
                                </ol>
                                <div class="price-btn blue">
                                    <a class="blue" href="#">Deposit</a>
                                </div>
                        ...
                        <div class="col-md-3 col-sm-6 col-xs-12">
                            <div class="pri_table_list">
                                ...
                                <div class="top-price-inner">
                                   <div class="rates">
                                        <span class="prices">?%</span><span class="users">Daily</span>
                                    </div>
                                    <span class="per-day">30 days</span>
                                </div>
                                <ol class="pricing-text">
                                    <li class="check">Minimum Invest : $100K</li>
                                    <li class="check">Maximum Invest : No</li>
                                    <li class="check">Percentage : Negotiable </li>
                                </ol>
                                <div class="price-btn blue">
                ...
                <div class="row">
					<div class="col-md-12 col-sm-12 col-xs-12">
						<div class="section-headline text-center">
                            ...
                            <p>We provide lasting Business investment for potential investors worldwide anytime anywhere so as to lift the future of Bitcion and digital banking with zero cost.</p>
						</div>
					</div>
				</div>
                <div class="row">
                    <div class="support-all">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                            <div class="support-services wow ">
                                ...
                                <div class="support-content">
                                    <h4>Secured Wallet</h4>
                                    <p>For every $ Invested we have it backed by sophisticated Hardware. Choose when and how much to Withdraw.</p>
                                </div>
                            </div>
                        </div>
                        <!-- Start About -->
                        <div class="col-md-6 col-sm-6 col-xs-12">
                            <div class="support-services ">
                                ...
                                <div class="support-content">
                                    ...
                                    <p>The coins we mine are all about Privacy, security and transparency, we totally comply with these ideals at all time.</p>
                                </div>
                            </div>
                        </div>
                        <!-- Start services -->
                        <div class="col-md-6 col-sm-6 col-xs-12">
                            <div class="support-services ">
                                ...
                                <div class="support-content">
                                    <h4>Total transperancy</h4>
                                    <p>Your mining outputs are automatically added to your account daily. No hidden fees or commissions.</p>
                                </div>
                            </div>
                        </div>
                        <!-- Start services -->
                        <div class="col-md-6 col-sm-6 col-xs-12">
                            <div class="support-services">
                                ...
                                <div class="support-content">
                                    ...
                                    <p>We provide professional expert support 24/7. Our online Chat is ready to respond to your every needs.</p>
                                </div>
                            </div>
                        </div>
                        <!-- Start services -->
                        <div class="col-md-6 col-sm-6 col-xs-12">
                            <div class="support-services ">
                                ...
                                <div class="support-content">
                                    <h4>Real Estate</h4>
                                    <p>We buy and sell properties from United States and a few European countries to make resonable profits.</p>
                                </div>
                            </div>
                        </div>
                        <!-- Start services -->
                        <div class="col-md-6 col-sm-6 col-xs-12">
                            <div class="support-services">
                                ...
                                <div class="support-content">
                                    ...
                                    <p>BTC and cryptocurrency trading is one thing we know how to do best, our experts are at alert.</p>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="row">
                    ...
                    <div class="col-md-6 col-sm-6 col-xs-12">
                        <div class="self-content">
							<h4>There was a time, just a decade ago when a dollar can buy you a Bitcoin, lots of people ignored the innovation.But today, what are we seeing? Most of those who were aware are now regretting why they never invested in it. The best time to invest is now. </h4>
                            <span class="talk-text">Paul Wilson, CEO</span>
                        </div>
                    </div>
                    <!-- column end -->
                </div>
			    ...
			    <div class="row">
					<div class="col-md-12 col-sm-12 col-xs-12">
						<div class="section-headline text-center">
                            ...
                            <p>A referral system that every investor can benefit from plus a welcome bonus</p>
						</div>
					</div>
				</div>
				<div class="row">
                                    ...
                                    <div class="single-proses">
                                        <div class="proses-content">
                                            ...
                                            <div class="proses-text">
                                                <h4>Level 01 instant 15% commission</h4>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="col-md-4 col-sm-4 col-xs-12">
                                    <div class="single-proses">
                                        <div class="proses-content">
                                            ...
                                            <div class="proses-text">
                                                <h4>Level 02 instant 10% commission</h4>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="col-md-4 col-sm-4 col-xs-12">
                                    <div class="single-proses last-item">
                                        <div class="proses-content">
                                            ...
                                            <div class="proses-text">
                                                <h4>Level 03 instant 5% commission</h4>
                                            </div>
                                        </div>
                                    </div>
                                </div>
               ...
               <div class="row">
					<div class="col-md-12 col-sm-12 col-xs-12">
						<div class="section-headline text-center">
                            ...
                            <p>As part of our transperancy policy we createed this system to automatically display the latest deposit and withdrawal.</p>
						</div>
					</div>
				</div>
                <div class="row">
                ...
                <div class="row">
					<div class="col-md-12 col-sm-12 col-xs-12">
						<div class="section-headline text-center">
							...
							<p>Read our latest publication which is related to our kind of business and investment platform.</p>
						</div>
					</div>
				</div>
                <div class="row">
                            ...
                            <div class="single-blog">
                                ...
                                <div class="blog-content">
                                   <div class="blog-meta">
                                    ...
                                    <a href="#">
                                        <h4>You can trust me and business together</h4>
                                    </a>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-md-4 col-sm-6 col-xs-12">
                            <div class="single-blog">
                                ...
                                <div class="blog-content">
                                    ...
                                    <a href="#">
                                        <h4>How to make more profit in a business</h4>
                                    </a>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-md-4 col-sm-6 col-xs-12">
                            <div class="single-blog">
                                <div class="blog-content">
                                    ...
                                    <a href="#">
                                        <h4>Business and investment, what to consider</h4>
                                    </a>
                                </div>
                                <div class="blog-image">
									<a class="image-scale" href="#">
                        ...
                        <div class="col-md-5 col-sm-5 col-xs-12">
                            <div class="testimonial-inner">
                                <div class="review-head">
                                    <h3>Our customer say about us</h3>
                                    <p>Our investment is almost risk-free. We also have full insurance cover in case of any lose. So your investment with us is assured. You have nothing to worry about.</p>
                                    <a class="reviews-btn" href="#">Sign Up</a>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="footer-content last-content">
                                <div class="footer-head">
                                    ...
                                    <div class="footer-contacts">
										...
										<p><span>Email :</span> info@your-domain.com</p>
										<p><span>Location :</span> 90 Drevermann St Bairnsdale VIC 3875, Australia</p>
									</div>
                    ...
                    <div class="row">
                        <div class="col-md-6 col-sm-6 col-xs-12">
                            <div class="copyright">
                                <p>
                                    Copyright © 2020
                                    <a href="#">INVpro - Bitcoin & Perfect Money Investment</a> All Rights Reserved
                                </p>
                            </div>
                        </div>
                    </div>
